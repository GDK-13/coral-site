...
```bash
python coral-1.6.0.pyz --versao
python coral-1.6.0.pyz --self-check
python coral-1.6.0.pyz --ambiente
```

## Executar e verificar arquivos

```bash
python coral-1.6.0.pyz executar programa.coral
python coral-1.6.0.pyz verificar programa.coral
```
