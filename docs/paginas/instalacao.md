...
A extensão oficial fica em `Instalacao/Extensao_VSCode/`. No VS Code, use **Extensions: Install from VSIX** e selecione o arquivo `coral-language-0.41.0.vsix`.
...
```bash
python Instalacao/Runtime/coral-1.5.9.pyz --self-check
python Instalacao/Runtime/coral-1.5.9.pyz --ambiente
```
